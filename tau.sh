...
# L2_MISS_LOADS are unreliable, see Intel forum post by Dr. Bandwidth.
# Use 2*64*PAPI_NATIVE:MEM_UOPS_RETIRED:ALL_STORES/mean time and look at
# _total_ for bandwidth.
